...
internal sealed class LogNode : ExprNode
{
    ...
    public LogNode(ExprNode argument) => Argument = argument;

    internal override double EvaluateCore(ReadOnlySpan<double> x) => Math.Log(Argument.Evaluate(x));
